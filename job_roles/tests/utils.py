...
def creates_job_role_skill_and_skill_level_instances():
    Skill.objects.create(name='test_skill_1')
    Skill.objects.create(name='test_skill_2')
    Skill.objects.create(name='test_skill_3')
    Skill.objects.create(name='test_skill_4')
